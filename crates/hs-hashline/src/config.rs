// Vendored from xai-org/grok-build (Apache-2.0), crates/codegen/xai-grok-tools/src/implementations/grok_build_hashline/config.rs
// The grok-build params-runtime pieces (ResourceType impl, build_tool_definition) are NOT
// vendored - they are bound to their tool runtime. See THIRD_PARTY_NOTICES.md.

//! Hashline scheme configuration — shared across all hashline tools.

use crate::scheme::{AnchorScheme, ChunkFingerprint, ContentOnly};
