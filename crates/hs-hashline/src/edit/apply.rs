// Vendored from xai-org/grok-build (Apache-2.0), crates/codegen/xai-grok-tools/src/implementations/grok_build_hashline/
...
mod tests {
    ...
    use crate::config::HashlineSchemeParams;
    use crate::scheme::{ChunkFingerprint, ContentOnly};
