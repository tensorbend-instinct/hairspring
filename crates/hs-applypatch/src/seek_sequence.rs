// Vendored from xai-org/grok-build (Apache-2.0), crates/codegen/xai-grok-tools/src/implementations/codex/apply_patch/seek_sequence.rs
// itself ported from openai/codex codex-rs/apply-patch (Apache-2.0). See THIRD_PARTY_NOTICES.md.
